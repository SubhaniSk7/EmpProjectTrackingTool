		...
		<fieldset>
			...
			<div class="form-group">
				<label class="col-md-4 control-label"
					for="employeeAssignmentProjectId">Project</label>
				<div class="col-md-4">
...
<!-- 			</div> -->
			...
			<div class="form-group control-group">
				<label class="col-md-4 control-label" for="employeeAssignmentEmpId">Employee </label>
				<div class="col-md-4">
				...
				<span class="help-inline text-primary">who are in <3 projects</span>
			</div>
