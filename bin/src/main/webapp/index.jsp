...
<body>
	...
	<nav class="navbar navbar-default  navbar-fixed-top" role="banner">
		...
		<!-- 		<div class="navbar-header"> -->
		<!-- 			<a class="navbar-brand" href="http://www.alacriti.com"> -->
		<!-- 				<img style="width:70;height:30px;toppad:-10px" src="images/alacriti-logo.gif" /> -->
		<!-- 					EmpProjectTrackingTool -->
		<!-- 			</a> -->
		<!-- 		</div> -->
		<div class="navbar-header">
			<a class="navbar-brand" href="http://www.alacriti.com">
				EmpProjectTrackingTool </a>
		</div>
					...
					<form class="form-horizontal" id="login-form" method="post">
						...
						<div style="margin-top: 10px" class="form-group">
							...
							<div class="col-sm-12 controls">
								...
								<button id='loginComplete' name="login" type="submit"
