		...
		.ready(
				function() {
					...
					$("#registerComplete").click(function(e) {
										...
										if ($("#registerEmpId").val() == null
												|| $("#registerEmpId").val() == '' || $("#registerFirstName").val()==null || $("#registerFirstName").val()==''
													|| $("#registerLastName").val()==null || $("#registerLastName").val()=='' || $("#registerEmail").val()==null || $("#registerEmail").val()==''
														|| $("#registerMobile").val()==null || $("#registerMobile").val()=='') {
											alert("Please fill all the fields");
										}
										else {
											var empId = $("#registerEmpId")
													.val();
