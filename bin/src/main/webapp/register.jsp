...
<body>
	...
	<div class="container-fluid">
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="http://192.168.35.190:8080/EmpProjectTrackingTool/index.jsp">Home</a></li>
...
<!-- 					name="username" placeholder="Emp Id"> -->
<!-- 			</div> -->
<!-- 			<div class="form-group"> -->
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-4 span4 offset4 text-center">
						...
						<a href="http://192.168.35.190:8080/EmpProjectTrackingTool/index.jsp"
